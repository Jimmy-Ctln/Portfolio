...
import frame2 from "/public/assets/diamond_frames/frame2.webp";
import frame4 from "/public/assets/diamond_frames/frame4.webp";
import main_picture from "/public/assets/profile_photos/main_picture.webp";
    ...
    <section id="home" className="w-full h-full pb-10 relative">
      <div className="flex px-20 items-center justify-center ml-52 gap-20 my-80 max-lg:mt-28 max-lg:pt-14 max-lg:mb-0 max-lg:flex-col max-xl:ml-0 max-xl:gap-10 max-sm:mt-32 max-sm:px-5">
        <div className="flex flex-col gap-6 items-baseline max-lg:mt-0 max-lg:items-center max-lg:text-center">
          ...
          <h2 className="text-5xl max-lg:text-4xl max-sm:text-3xl">
            Développeur web
          </h2>
          <motion.button
        ...
        <motion.div
          initial={{
            y: 0,
            boxShadow: "0px 0px 30px #2954A3",
            borderRadius: "90%",
          }}
          animate={{
            y: 10,
            boxShadow: "0px 0px 50px #2954A3",
            borderRadius: "100%",
          }}
          transition={{
            repeat: Infinity,
